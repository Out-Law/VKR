...
class BaseSlideSwitcher extends StatefulWidget {
  ...
  @override
  _BaseSlideSwitcherState createState() => _BaseSlideSwitcherState();
}

class _BaseSlideSwitcherState extends State<BaseSlideSwitcher>
  ...
  @override
  void dispose() {
    _controller.dispose();  // Assuming _animationController is your AnimationController
    super.dispose();
  }
